...
export default function IceHockeyScreen() {
  const router = useRouter();
  const colorScheme = useColorScheme();
  const colors = Colors[colorScheme ?? 'light'];
  const sportConfig = getSportConfig(SportType.ICE_HOCKEY);

  const { matches, loading, error, refresh } = useMatches(SportType.ICE_HOCKEY);
  ...
  const renderEmptyState = () => {
    ...
    return (
      <EmptyState
        ...
        message="There are no upcoming ice hockey matches at the moment. Pull down to refresh."
