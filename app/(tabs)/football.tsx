...
export default function FootballScreen() {
  ...
  const sportConfig = getSportConfig(SportType.FOOTBALL);

  const { matches, loading, error, refresh } = useMatches(SportType.FOOTBALL);
  ...
  const renderEmptyState = () => {
    ...
    return (
      <EmptyState
        ...
        message="There are no upcoming football matches at the moment. Pull down to refresh."
